package io.realm;//package io.realm;
//
...
// * @author ranjit
// */
//public abstract class TempRealmAdapter<T extends RealmModel, S extends RecyclerView.ViewHolder>
...
//     *
//     * @see #TempRealmAdapter(OrderedRealmCollection, boolean)
//     */
//    public TempRealmAdapter(@Nullable OrderedRealmCollection<T> data, boolean autoUpdate) {
